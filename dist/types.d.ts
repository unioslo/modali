 ...
 */
export declare type toggleModaliComponent<T> = (toggleOptions?: {
    payload?: T;
    options?: IModalOptions;
}) => void;
/**
 ...
 */
export declare type Modal = React.FC<IModalProps>;
/**
 ...
 */
export declare type Button = React.FC<IButtonProps>;
export {};
